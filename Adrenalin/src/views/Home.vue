    ...
    <main>
      <section>
        <div class="p-10 md:p-15 lg:p-20 text-center">
          ...
          >
            <span>
              Adrenalin — фитнес-центр в центре Минска для тех, кто хочет больше
              — здоровья, силы и энергии.
            </span>
          </h1>
        </div>
      ...
      <section>
        <div class="flex flex-col gap-y-5 p-10 text-center">
          ...
          <p>
            Фитнес-центр Adrenalin — это современное пространство для тех, кто
            ценит качество тренировок и профессиональный подход. Нас выбирают за
            атмосферу, опытных тренеров и индивидуальный подход к каждому
            клиенту.
          </p>
        </div>
        <div class="grid md:grid-cols-2 grid-col-1">
      ...
      <section>
        <div class="flex flex-col gap-y-5 p-10 text-center">
          <h2 class="font-bold text-title">
            <span>Наши тренеры - команда, которой можно доверять</span>
          </h2>
          <p>
            Только сертифицированные специалисты, регулярно повышающие
            квалификацию и работающие по международным стандартам.
          </p>
        </div>
        <div
          id="trainersCards"
      ...
      <section>
        <div class="flex flex-col gap-y-5 p-10 text-center">
          <h2 class="font-bold text-title">
            <span>Проверенные методики — гарантированный результат</span>
          </h2>
          <p>
            Мы не гонимся за модой — только работающие инструменты и грамотное
            сопровождение от сертифицированных тренеров.
          </p>
        </div>
        <div
          id="trainersCards"
      ...
      <section>
        <div class="flex flex-col gap-y-5 p-10 text-center">
          <h2 class="font-bold text-title">
            <span>Современное пространство для тренировок и отдыха</span>
          </h2>
          <p>
            Всё для вашего комфорта: просторные тренировочные зоны, душевые,
            лаунж-зона и фитнес-кафе с полезными напитками и перекусами.
          </p>
        </div>
      ...
      <section>
        ...
        >
          <div class="flex flex-col gap-y-5 p-5 border-b-2 border-black">
            <h2 class="font-bold text-title">
              <span>Решения приводят к результатам</span>
            </h2>
            <p>
              Мы не обещаем волшебство. Только системную работу, реальный
              прогресс и подход, проверенный временем. Начните с нами — и не
              захотите останавливаться.
            </p>
          </div>
          <address>
            <p>
          ...
          <ul class="flex justify-center space-x-4 text-title">
            <li>
              <a href="#" class="hover:text-green-400 duration-200"
      ...
      <iframe
        id="map"
        title="Карта с адресом фитнес-центра Adrenalin в центре Минска"
