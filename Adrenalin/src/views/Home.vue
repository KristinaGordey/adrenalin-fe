    ...
    <main>
      ...
      <section class="workers">
        <div class="container mx-auto px-4">
          <div class="mb-1">
            <h2 class="text-3xl text-center py-10 font-bold">
              <span>Тренерский состав</span>
            </h2>
          </div>
          <div id="trainersCards" class="flex flex-wrap -mx-4">
            <Workers
      ...
      <section class="about-us">
        ...
        <div class="row">
          <div class="col-12 py-5">
            <p>
              Добро пожаловать в фитнес-центр Adrenalin в Минске! Мы рады
              приветствовать Вас в пространстве, где здоровье и активный образ
              жизни становятся приоритетом. Наш фитнес-центр предлагает широкий
              спектр услуг, чтобы каждый мог достичь своих целей — будь то
              похудение, наращивание мышечной массы или просто поддержание
